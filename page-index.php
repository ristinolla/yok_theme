		...
		<div class="row">
			<section class="col-xs-12 col-md-8">
				...
				<div class="row event-list">
					<?php pr_event_list(array('length' => 4, 'item_class' => "col-xs-12 col-md-6 event-item")); ?>
				</div>
			...
			<section class="col-xs-12 col-md-4 news-section">
				...
				<?php pr_short_list_posts(array('before_list' => '<ul class="list-unstyled">', 'after_list' => '</ul>')); ?>
